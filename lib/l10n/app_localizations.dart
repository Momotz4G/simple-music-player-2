...
abstract class AppLocalizations {
  ...
  /// No description provided for @aboutEducationalPurpose.
  ///
  ...
  /// No description provided for @aboutNotForCommercial.
  ///
  /// In en, this message translates to:
  /// **'Not for commercial use.'**
  String get aboutNotForCommercial;
  ...
  /// No description provided for @accountDataMergeDesc.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @avatarPickerDesc.
  ///
  /// In en, this message translates to:
  ...
  String get behavioralHeader;

  /// No description provided for @behavioralTitles.
  ///
  /// In en, this message translates to:
  /// **'BEHAVIORAL'**
  String get behavioralTitles;

  /// No description provided for @binariesUpdateRequired.
  ///
  /// In en, this message translates to:
  /// **'Binaries Update Required'**
  String get binariesUpdateRequired;
  ...
  /// No description provided for @clearMetadataCache.
  ///
  /// In en, this message translates to:
  /// **'Clear Metadata & Art Cache'**
  ...
  /// No description provided for @competitiveTitles.
  ///
  /// In en, this message translates to:
  /// **'COMPETITIVE'**
  String get competitiveTitles;
  ...
  /// No description provided for @connectToADevice.
  ///
  /// In en, this message translates to:
  /// **'Connect to a Device'**
  ...
  /// No description provided for @connectionLostLeaderboard.
  ///
  /// In en, this message translates to:
  /// **'Connection Lost'**
  String get connectionLostLeaderboard;

  /// No description provided for @connectionLostLeaderboardDesc.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @consecutivePlaysTooltip.
  ///
  /// In en, this message translates to:
  /// **'Listen to the same song {count} times consecutively to obtain'**
  ...
  /// No description provided for @crownedChampionTitlesHeader.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @customSelected.
  ///
  /// In en, this message translates to:
  /// **'Custom Selected'**
  String get customSelected;
  ...
  /// No description provided for @developerExclusiveTooltip.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @emptyMailbox.
  ///
  /// In en, this message translates to:
  /// **'Empty Mailbox'**
  String get emptyMailbox;

  /// No description provided for @emptyMailboxDesc.
  ///
  /// In en, this message translates to:
  /// **'This will delete all messages permanently.'**
  String get emptyMailboxDesc;

  /// No description provided for @emptyMailboxTitle.
  ///
  /// In en, this message translates to:
  /// **'Empty Mailbox?'**
  String get emptyMailboxTitle;
  ...
  /// In en, this message translates to:
  /// **'EXCLUSIVE'**
  String get exclusiveTitles;

  /// No description provided for @exclusiveTitlesHeader.
  ///
  /// In en, this message translates to:
  /// **'EXCLUSIVE TITLES'**
  String get exclusiveTitlesHeader;
  ...
  ///
  /// In en, this message translates to:
  /// **'Sleep Timer: Fading out at end of track...'**
  ...
  /// No description provided for @finishUpdate.
  ///
  /// In en, this message translates to:
  /// **'Finish Update'**
  String get finishUpdate;

  /// No description provided for @finishes.
  ///
  /// In en, this message translates to:
  /// **'Finishes'**
  String get finishes;
  ...
  /// No description provided for @foundExistingAccount.
  ///
  /// In en, this message translates to:
  /// **'We found an existing account for \'{name}\'.'**
  ...
  /// No description provided for @foundYoutubeResults.
  ///
  /// In en, this message translates to:
  /// **'Found {count} results on YouTube'**
  ...
  /// No description provided for @globalMailbox.
  ///
  /// In en, this message translates to:
  /// **'Global Mailbox'**
  String get globalMailbox;
  ...
  /// No description provided for @globalRankingsDesc.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @hallOfFameTitles.
  ///
  /// In en, this message translates to:
  /// **'HALL OF FAME'**
  String get hallOfFameTitles;
  ...
  ///
  /// In en, this message translates to:
  /// **'Listen to {minutes} minutes of music'**
  ...
  /// No description provided for @localPlayHistorySaved.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @mergeAccountData.
  ///
  /// In en, this message translates to:
  /// **'Merge Account Data?'**
  String get mergeAccountData;

  /// No description provided for @metadataCacheCleared.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @minShortLabel.
  ///
  /// In en, this message translates to:
  /// **'min'**
  String get minShortLabel;
  ...
  /// No description provided for @minsShort.
  ///
  /// In en, this message translates to:
  /// **'M'**
  String get minsShort;

  /// No description provided for @minsShortLabel.
  ///
  /// In en, this message translates to:
  /// **'mins'**
  String get minsShortLabel;
  ...
  /// No description provided for @mostListenedArtist.
  ///
  /// In en, this message translates to:
  /// **'Most Listened Artist'**
  String get mostListenedArtist;
  ...
  /// No description provided for @notRank.
  ///
  /// In en, this message translates to:
  /// **'Not Rank {rank}'**
  String notRank(int rank);

  /// No description provided for @notRanked.
  ///
  /// In en, this message translates to:
  /// **'Not Ranked'**
  String get notRanked;

  /// No description provided for @notRankedTop3.
  ///
  /// In en, this message translates to:
  /// **'NOT RANKED Top 3'**
  String get notRankedTop3;
  ...
  /// No description provided for @reachDailyPlaysTooltip.
  ///
  /// In en, this message translates to:
  /// **'Reach {count} plays in a single day to obtain'**
  String reachDailyPlaysTooltip(int count);

  /// No description provided for @reachSpecificArtistTooltip.
  ///
  /// In en, this message translates to:
  /// **'Reach {minutes} minutes with a specific artist to obtain'**
  String reachSpecificArtistTooltip(String minutes);

  /// No description provided for @reachWeeklyPlaysTooltip.
  ///
  /// In en, this message translates to:
  /// **'Reach {count} plays in a single week to obtain'**
  ...
  /// No description provided for @resetDataUsage.
  ///
  /// In en, this message translates to:
  /// **'Reset Data Usage'**
  String get resetDataUsage;

  /// No description provided for @resetDataUsageContent.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @searchingEngine.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @secsShort.
  ///
  /// In en, this message translates to:
  /// **'S'**
  String get secsShort;
  ...
  /// No description provided for @showAllTitles.
  ///
  /// In en, this message translates to:
  /// **'Show All {count} Titles'**
  ...
  /// No description provided for @showUnlockedOnly.
  ///
  /// In en, this message translates to:
  /// **'Show unlocked only'**
  ...
  /// No description provided for @songLabelUpper.
  ///
  /// In en, this message translates to:
  /// **'SONG'**
  ...
  /// No description provided for @superfanHeader.
  ///
  /// In en, this message translates to:
  /// **'SUPERFAN ACHIEVEMENTS'**
  String get superfanHeader;

  /// No description provided for @superfanTitles.
  ///
  /// In en, this message translates to:
  /// **'SUPERFAN'**
  String get superfanTitles;

  /// No description provided for @supportDeveloperTooltip.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @timeBasedTitles.
  ///
  /// In en, this message translates to:
  /// **'TIME-BASED'**
  String get timeBasedTitles;
  ...
  /// No description provided for @timeOverlordsHeader.
  ///
  /// In en, this message translates to:
  /// **'TIME OVERLORDS'**
  String get timeOverlordsHeader;
  ...
  /// No description provided for @top3GlobalTooltip.
  ///
  /// In en, this message translates to:
  /// **'Reach Top 3 Global for {weeks} week(s)'**
  ...
  /// No description provided for @topArtistAndTrack.
  ///
  /// In en, this message translates to:
  /// **'Top Artist and Track'**
  String get topArtistAndTrack;
  ...
  /// No description provided for @topGlobalTooltip.
  ///
  /// In en, this message translates to:
  /// **'Reach top {rank} global to obtain'**
  String topGlobalTooltip(int rank);

  /// No description provided for @topListeners.
  ///
  /// In en, this message translates to:
  /// **'Top Listeners'**
  String get topListeners;

  /// No description provided for @totalMinutesStat.
  ///
  /// In en, this message translates to:
  /// **'Total Minutes'**
  String get totalMinutesStat;
  ...
  /// No description provided for @unlinkAccountDesc.
  ///
  /// In en, this message translates to:
  /// **'Your stats will remain on this device but will no longer sync across devices.'**
  String get unlinkAccountDesc;

  /// No description provided for @unlinkAccountQuestion.
  ///
  /// In en, this message translates to:
  /// **'Unlink Account?'**
  String get unlinkAccountQuestion;
  ...
  /// No description provided for @worldTopArtists.
  ///
  /// In en, this message translates to:
  /// **'World Top Artists'**
  String get worldTopArtists;
